const CERTAINLY_POPUPS = [
    ...
    trigger: "inactivity", // String or function. If string, accepted values are: "page_load", "inactivity", "chat_minimized". If function, it must return a boolean value: true or false
    ...
    repeat_after: 2, // Number of times after which this popup will show up again
